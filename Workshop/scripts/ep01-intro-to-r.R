...
Name_of_workshop <- "Introduction to R"
...
# mass_index <- mass/age  # mass_index is: 0.9313725490
#
...
ft <- 3                   # length in feet
in <- ft * 12             # conversion of feet to inches
cms <- in * 2.54          # conversion factor 2.54 from centimetres into inches
m = cms / 100             # convert from centimetres to metres
